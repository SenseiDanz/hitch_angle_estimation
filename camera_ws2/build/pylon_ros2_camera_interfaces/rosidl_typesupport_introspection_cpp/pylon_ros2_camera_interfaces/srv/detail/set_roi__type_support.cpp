...
{
  new (message_memory) pylon_ros2_camera_interfaces::srv::SetROI_Request(_init);
}

void SetROI_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pylon_ros2_camera_interfaces::srv::SetROI_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetROI_Request_message_member_array[1] = {
  {
    ...
    offsetof(pylon_ros2_camera_interfaces::srv::SetROI_Request, target_roi),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetROI_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(pylon_ros2_camera_interfaces::srv::SetROI_Request),
...
{
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_introspection_cpp::SetROI_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pylon_ros2_camera_interfaces, srv, SetROI_Request)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_introspection_cpp::SetROI_Request_message_type_support_handle;
}
...
void SetROI_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) pylon_ros2_camera_interfaces::srv::SetROI_Response(_init);
}

void SetROI_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pylon_ros2_camera_interfaces::srv::SetROI_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetROI_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pylon_ros2_camera_interfaces::srv::SetROI_Response, reached_roi),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pylon_ros2_camera_interfaces::srv::SetROI_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetROI_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(pylon_ros2_camera_interfaces::srv::SetROI_Response),
...
{
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_introspection_cpp::SetROI_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pylon_ros2_camera_interfaces, srv, SetROI_Response)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_introspection_cpp::SetROI_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetROI_service_members = {
  ...
  // see get_service_type_support_handle<pylon_ros2_camera_interfaces::srv::SetROI>()
...
get_service_type_support_handle<pylon_ros2_camera_interfaces::srv::SetROI>()
{
  ...
  auto service_type_support =
    &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_introspection_cpp::SetROI_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pylon_ros2_camera_interfaces, srv, SetROI)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<pylon_ros2_camera_interfaces::srv::SetROI>();
}
