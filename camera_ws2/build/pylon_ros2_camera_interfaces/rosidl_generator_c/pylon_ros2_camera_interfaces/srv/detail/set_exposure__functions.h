...
#ifndef PYLON_ROS2_CAMERA_INTERFACES__SRV__DETAIL__SET_EXPOSURE__FUNCTIONS_H_
#define PYLON_ROS2_CAMERA_INTERFACES__SRV__DETAIL__SET_EXPOSURE__FUNCTIONS_H_
 ...
 * calls
 * pylon_ros2_camera_interfaces__srv__SetExposure_Request__init().
...
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetExposure_Request__fini()
 ...
 * pylon_ros2_camera_interfaces__srv__SetExposure_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetExposure_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pylon_ros2_camera_interfaces__srv__SetExposure_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pylon_ros2_camera_interfaces
...
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetExposure_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pylon_ros2_camera_interfaces
...
/**
 * It allocates the memory for the array and calls
 * pylon_ros2_camera_interfaces__srv__SetExposure_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pylon_ros2_camera_interfaces
...
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetExposure_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PYLON_ROS2_CAMERA_INTERFACES__SRV__DETAIL__SET_EXPOSURE__FUNCTIONS_H_
