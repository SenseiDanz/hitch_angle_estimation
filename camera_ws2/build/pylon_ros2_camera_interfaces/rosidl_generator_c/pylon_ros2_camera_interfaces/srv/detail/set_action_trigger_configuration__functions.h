...
#ifndef PYLON_ROS2_CAMERA_INTERFACES__SRV__DETAIL__SET_ACTION_TRIGGER_CONFIGURATION__FUNCTIONS_H_
#define PYLON_ROS2_CAMERA_INTERFACES__SRV__DETAIL__SET_ACTION_TRIGGER_CONFIGURATION__FUNCTIONS_H_
...
/// Initialize srv/SetActionTriggerConfiguration message.
/**
...
/// Finalize srv/SetActionTriggerConfiguration message.
/**
...
/// Create srv/SetActionTriggerConfiguration message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Request__init().
...
/// Destroy srv/SetActionTriggerConfiguration message.
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Request__fini()
...
/// Check for srv/SetActionTriggerConfiguration message equality.
/**
...
/// Copy a srv/SetActionTriggerConfiguration message.
/**
...
/// Initialize array of srv/SetActionTriggerConfiguration messages.
/**
...
/// Finalize array of srv/SetActionTriggerConfiguration messages.
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Request__fini()
...
/// Create array of srv/SetActionTriggerConfiguration messages.
/**
 * It allocates the memory for the array and calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetActionTriggerConfiguration messages.
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetActionTriggerConfiguration message array equality.
/**
...
/// Copy an array of srv/SetActionTriggerConfiguration messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pylon_ros2_camera_interfaces
...
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pylon_ros2_camera_interfaces
...
/**
 * It allocates the memory for the array and calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pylon_ros2_camera_interfaces
...
/**
 * It calls
 * pylon_ros2_camera_interfaces__srv__SetActionTriggerConfiguration_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PYLON_ROS2_CAMERA_INTERFACES__SRV__DETAIL__SET_ACTION_TRIGGER_CONFIGURATION__FUNCTIONS_H_
