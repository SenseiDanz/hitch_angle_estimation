...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__init(pylon_ros2_camera_interfaces__action__GrabImages_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__float__Sequence__init(&msg->exposure_times, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(msg);
    return false;
  }
  // gain_given
  // gain_values
  if (!rosidl_runtime_c__float__Sequence__init(&msg->gain_values, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(msg);
    return false;
  }
  // gamma_given
  // gamma_values
  if (!rosidl_runtime_c__float__Sequence__init(&msg->gamma_values, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(msg);
    return false;
  }
  // brightness_given
  // brightness_values
  if (!rosidl_runtime_c__float__Sequence__init(&msg->brightness_values, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(msg);
    return false;
  }
  // exposure_auto
...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(pylon_ros2_camera_interfaces__action__GrabImages_Goal * msg)
{
  ...
  // gain_given
  // gain_values
  rosidl_runtime_c__float__Sequence__fini(&msg->gain_values);
  // gamma_given
  // gamma_values
  rosidl_runtime_c__float__Sequence__fini(&msg->gamma_values);
  // brightness_given
  // brightness_values
  rosidl_runtime_c__float__Sequence__fini(&msg->brightness_values);
  // exposure_auto
  // gain_auto
}
...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_Goal * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_Goal * rhs)
{
  ...
  // gain_given
  if (lhs->gain_given != rhs->gain_given) {
    return false;
  }
  // gain_values
  if (!rosidl_runtime_c__float__Sequence__are_equal(
  ...
  // gamma_given
  if (lhs->gamma_given != rhs->gamma_given) {
    return false;
  }
  // gamma_values
  if (!rosidl_runtime_c__float__Sequence__are_equal(
  ...
  // brightness_given
  if (lhs->brightness_given != rhs->brightness_given) {
    return false;
  }
  // brightness_values
  if (!rosidl_runtime_c__float__Sequence__are_equal(
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_Goal * output)
{
  ...
  // gain_given
  output->gain_given = input->gain_given;
  // gain_values
  if (!rosidl_runtime_c__float__Sequence__copy(
      &(input->gain_values), &(output->gain_values)))
  {
    return false;
  }
  // gamma_given
  output->gamma_given = input->gamma_given;
  // gamma_values
  if (!rosidl_runtime_c__float__Sequence__copy(
      &(input->gamma_values), &(output->gamma_values)))
  {
    return false;
  }
  // brightness_given
  output->brightness_given = input->brightness_given;
  // brightness_values
  if (!rosidl_runtime_c__float__Sequence__copy(
      &(input->brightness_values), &(output->brightness_values)))
  {
    return false;
  }
  // exposure_auto
...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__create()
{
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_Goal * msg = (pylon_ros2_camera_interfaces__action__GrabImages_Goal *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Goal));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_Goal__init(msg);
  if (!success) {
...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Goal * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_Goal *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(&data[i - 1]);
      }
...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence__init(array, size);
  if (!success) {
...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_Goal * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_Goal__copy(
...
pylon_ros2_camera_interfaces__action__GrabImages_Result__init(pylon_ros2_camera_interfaces__action__GrabImages_Result * msg)
{
  ...
  if (!sensor_msgs__msg__Image__Sequence__init(&msg->images, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(msg);
    return false;
  }
  // cam_info
  ...
  if (!rosidl_runtime_c__float__Sequence__init(&msg->reached_brightness_values, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(msg);
    return false;
  }
  // reached_gain_values
  if (!rosidl_runtime_c__float__Sequence__init(&msg->reached_gain_values, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(msg);
    return false;
  }
  // reached_gamma_values
  if (!rosidl_runtime_c__float__Sequence__init(&msg->reached_gamma_values, 0)) {
    pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(msg);
    return false;
  }
  // success
...
pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(pylon_ros2_camera_interfaces__action__GrabImages_Result * msg)
{
  ...
  // reached_brightness_values
  rosidl_runtime_c__float__Sequence__fini(&msg->reached_brightness_values);
  // reached_gain_values
  rosidl_runtime_c__float__Sequence__fini(&msg->reached_gain_values);
  // reached_gamma_values
  rosidl_runtime_c__float__Sequence__fini(&msg->reached_gamma_values);
  // success
}
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_Result * output)
{
  ...
  // reached_brightness_values
  if (!rosidl_runtime_c__float__Sequence__copy(
      &(input->reached_brightness_values), &(output->reached_brightness_values)))
  {
    return false;
  }
  // reached_gain_values
  if (!rosidl_runtime_c__float__Sequence__copy(
      &(input->reached_gain_values), &(output->reached_gain_values)))
  {
    return false;
  }
  // reached_gamma_values
  if (!rosidl_runtime_c__float__Sequence__copy(
      &(input->reached_gamma_values), &(output->reached_gamma_values)))
  {
    return false;
  }
  // success
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Result * msg = (pylon_ros2_camera_interfaces__action__GrabImages_Result *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Result));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Result * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_Result *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_Result * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_Feedback__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_Feedback * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_Feedback * rhs)
{
  ...
  // curr_nr_images_taken
  if (lhs->curr_nr_images_taken != rhs->curr_nr_images_taken) {
    return false;
  }
  return true;
}
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_Feedback * output)
{
  ...
  // curr_nr_images_taken
  output->curr_nr_images_taken = input->curr_nr_images_taken;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Feedback * msg = (pylon_ros2_camera_interfaces__action__GrabImages_Feedback *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Feedback));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_Feedback__destroy(pylon_ros2_camera_interfaces__action__GrabImages_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    pylon_ros2_camera_interfaces__action__GrabImages_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Feedback * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_Feedback *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_Feedback * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__init(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!pylon_ros2_camera_interfaces__action__GrabImages_Goal__init(&msg->goal)) {
    pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__fini(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request * msg)
{
  ...
  // goal
  pylon_ros2_camera_interfaces__action__GrabImages_Goal__fini(&msg->goal);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!pylon_ros2_camera_interfaces__action__GrabImages_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request * msg = (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__init(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response * msg = (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__init(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request * msg = (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__init(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!pylon_ros2_camera_interfaces__action__GrabImages_Result__init(&msg->result)) {
    pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__fini(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response * msg)
{
  ...
  // status
  // result
  pylon_ros2_camera_interfaces__action__GrabImages_Result__fini(&msg->result);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response * rhs)
{
  ...
  // result
  if (!pylon_ros2_camera_interfaces__action__GrabImages_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response * msg = (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__init(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!pylon_ros2_camera_interfaces__action__GrabImages_Feedback__init(&msg->feedback)) {
    pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__fini(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  pylon_ros2_camera_interfaces__action__GrabImages_Feedback__fini(&msg->feedback);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!pylon_ros2_camera_interfaces__action__GrabImages_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage * msg = (pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage));
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence__init(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage * data = NULL;

  if (size) {
    data = (pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage *)allocator.zero_allocate(size, sizeof(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence__fini(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence * array = (pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence *)allocator.allocate(sizeof(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence__destroy(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence__are_equal(const pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence * lhs, const pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage * data =
      (pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pylon_ros2_camera_interfaces__action__GrabImages_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
