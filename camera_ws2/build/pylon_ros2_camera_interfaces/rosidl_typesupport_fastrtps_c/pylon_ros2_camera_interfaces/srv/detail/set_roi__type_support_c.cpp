...
#include "pylon_ros2_camera_interfaces/srv/detail/set_roi__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/region_of_interest__functions.h"  // target_roi
...
using _SetROI_Request__ros_msg_type = pylon_ros2_camera_interfaces__srv__SetROI_Request;
...
size_t get_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetROI_Request__ros_msg_type * ros_message = static_cast<const _SetROI_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetROI_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pylon_ros2_camera_interfaces
size_t max_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pylon_ros2_camera_interfaces__srv__SetROI_Request;
    is_plain =
      (
...
static size_t _SetROI_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetROI_Request)() {
...
// already included above
// #include "sensor_msgs/msg/detail/region_of_interest__functions.h"  // reached_roi
...
using _SetROI_Response__ros_msg_type = pylon_ros2_camera_interfaces__srv__SetROI_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pylon_ros2_camera_interfaces
size_t get_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetROI_Response__ros_msg_type * ros_message = static_cast<const _SetROI_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pylon_ros2_camera_interfaces
size_t max_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pylon_ros2_camera_interfaces__srv__SetROI_Response;
    is_plain =
      (
...
static size_t _SetROI_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pylon_ros2_camera_interfaces__srv__SetROI_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetROI_Response)() {
...
// already included above
// #include "pylon_ros2_camera_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "pylon_ros2_camera_interfaces/srv/set_roi.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetROI)() {
