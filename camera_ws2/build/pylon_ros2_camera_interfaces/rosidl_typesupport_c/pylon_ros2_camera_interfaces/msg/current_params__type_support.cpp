...
static const _CurrentParams_type_support_symbol_names_t _CurrentParams_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, msg, CurrentParams)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, msg, CurrentParams)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, msg, CurrentParams)() {
  return &::pylon_ros2_camera_interfaces::msg::rosidl_typesupport_c::CurrentParams_message_type_support_handle;
}
