...
static const _SetBrightness_Request_type_support_symbol_names_t _SetBrightness_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetBrightness_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetBrightness_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetBrightness_Request)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetBrightness_Request_message_type_support_handle;
}
...
static const _SetBrightness_Response_type_support_symbol_names_t _SetBrightness_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetBrightness_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetBrightness_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetBrightness_Response)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetBrightness_Response_message_type_support_handle;
}
...
static const _SetBrightness_type_support_symbol_names_t _SetBrightness_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetBrightness)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetBrightness)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetBrightness)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetBrightness_service_type_support_handle;
}
