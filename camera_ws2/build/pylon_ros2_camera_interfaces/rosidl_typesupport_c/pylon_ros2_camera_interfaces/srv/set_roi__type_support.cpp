...
static const _SetROI_Request_type_support_symbol_names_t _SetROI_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetROI_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetROI_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetROI_Request)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetROI_Request_message_type_support_handle;
}
...
static const _SetROI_Response_type_support_symbol_names_t _SetROI_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetROI_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetROI_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetROI_Response)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetROI_Response_message_type_support_handle;
}
...
static const _SetROI_type_support_symbol_names_t _SetROI_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetROI)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetROI)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetROI)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetROI_service_type_support_handle;
}
