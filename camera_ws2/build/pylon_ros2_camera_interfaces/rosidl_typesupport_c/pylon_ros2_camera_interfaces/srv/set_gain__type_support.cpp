...
static const _SetGain_Request_type_support_symbol_names_t _SetGain_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetGain_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetGain_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetGain_Request)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetGain_Request_message_type_support_handle;
}
...
static const _SetGain_Response_type_support_symbol_names_t _SetGain_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetGain_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetGain_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetGain_Response)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetGain_Response_message_type_support_handle;
}
...
static const _SetGain_type_support_symbol_names_t _SetGain_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pylon_ros2_camera_interfaces, srv, SetGain)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pylon_ros2_camera_interfaces, srv, SetGain)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pylon_ros2_camera_interfaces, srv, SetGain)() {
  return &::pylon_ros2_camera_interfaces::srv::rosidl_typesupport_c::SetGain_service_type_support_handle;
}
